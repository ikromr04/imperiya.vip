...
import { getAuthUser, getRegisterLinks } from '@/store/auth-slice/auth-selector';
...
function RegisterLinksPage(): JSX.Element {
  ...
  let columns: ColumnDef<RegisterLink>[] = [
    {
      id: 'expiresAt',
      ...
      <main className="pt-4 pb-10">
        ...
        {links.data ? (
          <DataTable
            ...
            actions={authUser?.role === 'superadmin' && <GenerateButton />}
          />
        ) : (
