            ...
            acc.push({
              ...
              cell: ({ row }) => {
                ...
                if (!rating) {
                  ...
                  return (
                    <input
                      className="flex justify-center items-center text-center min-w-9 min-h-9 bg-transparent focus:outline-0 text-blue-500 placeholder:text-blue-300"
                      type="number"
                      readOnly
                ...
                return (
                  <input
                    className="flex justify-center items-center text-center font-semibold text-blue-500 min-w-9 min-h-9 bg-transparent focus:outline-0"
                    type="number"
                    readOnly
            ...
            acc.push({
              ...
              cell: ({ row }) => {
                ...
                if (!mark) {
                  ...
                  return (
                    <input
                      className="flex justify-center items-center text-center min-w-9 min-h-9 bg-transparent focus:outline-0"
                      readOnly
