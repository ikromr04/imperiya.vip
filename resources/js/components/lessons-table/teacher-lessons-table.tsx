...
import TeacherLessonItem from './teacher-lessons-item';
...
function TeacherLessonsTable(): JSX.Element {
  ...
  }, [authUser, dispatch, grades.data, grades.isFetching, lessons, subjects.data, subjects.isFetching, week]);
  ...
  if (!lessons || !subjects.data || !authUser || !grades.data) return <Spinner className="w-8 h-8" />;
