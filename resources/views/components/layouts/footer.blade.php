    ...
    <div class="flex flex-wrap gap-6 lg:justify-around">
      <section>
        ...
        <ul class="flex flex-col gap-2">
          <li>
            <a class="opacity-70 transition-all duration-300 hover:opacity-100" href="{{ route('journal', 'journal/books') }}">
              {{ __('Библиотека') }}
            </a>
          </li>
          <li>
            <a class="opacity-70 transition-all duration-300 hover:opacity-100" href="{{ route('journal', 'journal/schedule') }}">
      ...
      <section>
        ...
        <ul class="flex flex-col gap-2">
          <li>
            <a class="opacity-70 transition-all duration-300 hover:opacity-100 flex items-center gap-2" href="https://facebook.com/ImperiumschoolTj" target="_blank">
          ...
          <li>
            <a class="opacity-70 transition-all duration-300 hover:opacity-100 flex items-center gap-2" href="https://www.instagram.com/imperiyaschool" target="_blank">
