<header {{ $attributes->merge([
  ...
  <div class="container flex items-center pt-6 gap-3 sm:gap-4 md:pt-7 lg:items-end">
    ...
    <a class="flex items-center justify-center max-w-max max-h-max justify-self-end min-w-8 min-h-8 sm:min-h-10 order-2 text-white bg-emerald-500 shadow-md transition-all duration-150 hover:shadow-none hover:bg-emerald-600 rounded-md px-3 sm:px-5 lg:order-3" href="/auth/profile">
